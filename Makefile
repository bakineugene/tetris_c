...
build-sdl: sounds main.c tetris/position.c tetris/pieces.c tetris/colours.c tetris/tetris.c sdl2/renderer.c sdl2/sound.h
	mkdir -p build
	gcc -Wall main.c tetris/position.c tetris/pieces.c tetris/colours.c tetris/tetris.c sdl2/renderer.c -lSDL2 -lSDL2main -o ./build/sdl_tetris
